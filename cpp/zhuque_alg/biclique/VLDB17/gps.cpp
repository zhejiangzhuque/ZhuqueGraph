...
//string order = "core";p=4 q=4 int sampleEdges = 1000000;bool onePQ = true;double alpha = 0.0;
int gps(string fPath,int graphMode,string order,int p,int q,int sampleEdges,bool onePQ,double alpha){
    if(fPath=="") {
        printf("file path: -f\n");
        return 0;
    }
...
PYBIND11_MODULE(gpsbiclique , m){
    m.def("gps", &gps,
          pybind11::arg("filePath")="",pybind11::arg("graphMode")=0,pybind11::arg("order")="core",
          pybind11::arg("p")=4,pybind11::arg("q")=4,pybind11::arg("sampleEdges")=1000000,
          pybind11::arg("onePQ")=true,pybind11::arg("alpha")=0.0);
}