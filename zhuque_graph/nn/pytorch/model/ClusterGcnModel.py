...
from zhuque_graph.nn.pytorch.layer.ics_gnn_layers import StackedGCN
...
class ClusterGCNTrainer(object):
    ...
    def train_test_community(self):
        ...
        for i in epochs:
            ...
            epochs.set_description("\nTrain Loss: %g" % round(average_loss, 4))
            zhuque_visdom.append_line(i,round(average_loss, 4))
            zhuque_tensorboard.draw_line(i,round(average_loss, 4))
        ### Test Phrase
        self.model.eval()
        self.predictions = []
        self.targets = []
