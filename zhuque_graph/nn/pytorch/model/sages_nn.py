...
class SAGES(torch.nn.Module):
    ...
    def __init__(self, feat_channels, hidden_channels, encoder, summary, corruption, s_decoder=None):
        """
        :param hidden_channels: 隐层向量维度
        :param encoder: 编码器
        :param summary: dgi的readout函数
        :param corruption: dgi的腐蚀函数
        :param s_decoder: gae的structure函数
       """
        ...
        # weight是deep graph infomax中的weight使用的
    ...
    def forward(self, *args, **kwargs):
        ...
        # summary是dgi的readout函数
        summary = self.summary(pos_z, *args, **kwargs)
        return pos_z, neg_z, summary

    def discriminate(self, z, summary, sigmoid=True):
        # 计算z[n, dim]矩阵和社区向量的相似性
